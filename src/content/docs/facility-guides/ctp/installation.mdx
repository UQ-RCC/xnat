---
title: Installation
description: Install the Clinical Trials Processor on Windows 10 and configure it to send de-identified DICOM to UQ XNAT
---
...
1. Create a new user for CTP on UQ XNAT (not an AAF/OpenID user) with required project access, without admin access
